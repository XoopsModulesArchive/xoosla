 ...
 * @version $Id: notification_update.php 26 2012-02-17 09:16:15Z catzwolf $
 */
...
if ( !isset( $_POST['not_submit'] ) ) {
	redirect_header( $_POST['not_redirect'], 1, _NOPERM );
	exit();
}

if ( !$GLOBALS['xoopsSecurity']->check() ) {
	redirect_header( $_POST['not_redirect'], 1, implode( '<br />', $GLOBALS['xoopsSecurity']->getErrors() ) );
	exit();
}
