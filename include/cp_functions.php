...
{
	echo '<table cellpadding="2" cellspacing="1" width="98%" class="outer"><tr><td class="head">' . $title . '</td></tr><tr><td><br />' . $content . '<br /></td></tr></table>';
}
	...
	foreach ( $mods as $mod ) {
		...
		if ( count( $adminmenu ) != 0 ) {
			...
			foreach ( $adminmenu as $menuitem ) {
				...
				$menu_layers .= "\n<img src='\".XOOPS_URL.\"/images/icons/pointer.gif' width='8' height='8' alt='' />&nbsp;<a href='" . $menu_link . "'" . $menu_target . " onmouseover='popUpL" . $mid . "' >" . $menu_title . "</a><br />\n";
			}
		}
