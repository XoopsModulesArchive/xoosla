...
define($constpref."_DESC","Этот модуль защищает ваш сайт на базе Xoosla! от различного вида атак, таких как: DoS, SQL Injection и порчи переменных.");
...
define($constpref.'_CONTAMI_ACTIONDS','Выберите действие выполняемое в случае когда кто-либо пытается передать вашему скрипту "грязные" системные переменные Xoosla!. (Рекомендуется: пустой экран)');
...
define($constpref.'_DISABLES','Деактивировать потенциально опасные функции Xoosla!');
