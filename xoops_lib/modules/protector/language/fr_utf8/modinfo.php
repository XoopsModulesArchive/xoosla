...
define($constpref."_CONTAMI_ACTIONDS","Selectionner l'action lorsque protector détecte une tentative de contamination des variables globales du systéme Xoosla!.<br />(Conseil : écran blanc récommendé)");
...
define($constpref."_DISABLES","Désactiver les fonctions dangereuses dans Xoosla!");
