...
define($constpref."_DESC","Módulo para proteção do Xoosla! contra ataques mal-intencionados, em especial: ataques DoS, SQL Injection e contaminações por variável.");
...
define($constpref.'_CONTAMI_ACTIONDS',"Escolha o tipo de solução quando uma tentativa de alteração das globais de sistema do Xoosla! for detectada.<br />(Padrão: \"Encerramento forçado de sessão\")");
