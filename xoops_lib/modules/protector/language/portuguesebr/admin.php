...
define("_AM_ADV_REGISTERGLOBALS","Esta configuração permite uma variedade de ataques por injeîåo.<br />Se seu servidor suportar .htaccess, crie ou edite-o no diretóriio em que o Xoosla! estiver instalado.");
...
define("_AM_ADV_USETRANSSID","Suas configurções estão definidas para exibir o ID da sessão nos links.<br />Para proteger-se contra session hijack, crie ou edite um .htaccess no diretório em que o Xoosla! estiver instalado.<br /><b>php_flag session.use_trans_sid off</b>");
define("_AM_ADV_DBPREFIX","O prefixo do seu banco de dados é o padrão (\"Xoosla!\"), o que o faz vulnerá×el à SQL injection.<br />Não se esqueça de ativar \"Sanitização em caso de detecção de comentários isolados\" e as proteções contra SQL injection.");
