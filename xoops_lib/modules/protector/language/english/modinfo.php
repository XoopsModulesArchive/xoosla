...
define($constpref."_DESC","This module protects your Xoosla site from various attacks like DoS , SQL Injection , and Variables contaminations.");
...
define($constpref.'_DIE_BADEXTDSC','If someone tries to upload files which have bad extensions like .php , this module exits your Xoosla!.<br />If you often attach php files into B-Wiki or PukiWikiMod, turn this off.');
define($constpref.'_CONTAMI_ACTION','Action if a contamination is found');
define($constpref.'_CONTAMI_ACTIONDS','Select the action when someone tries to contaminate system global variables into your Xoosla!.<br />(recommended option is blank screen)');
...
define($constpref.'_DISABLES','Disable dangerous features in Xoosla!');
