...
define($constpref.'_DIE_BADEXTDSC','Wenn jemand versucht, Dateien mit unzulassigen Endungen wie .php hochzuladen, beendet diese Modul den Zugriff fur Xoosla!.<br />Wenn Sie oft Dateien in B-Wiki oder PukiWikiMod einstellen, schalten Sie diese Option aus.');
define($constpref.'_CONTAMI_ACTION','Masnahmen, wenn eine Verunreinigung gefunden wurde:');
define($constpref.'_CONTAMI_ACTIONDS','Wahlen Sie eine Aktion aus, wenn jemand versucht, globale Xoosla!-Variablen zu verunreinigen.<br />(Empfohlen wird "Weiser Bildschirm")');
