...
define($constpref."_DESC","Ce module prot&egrave;ge votre site Xoosla! d'attaques vari&eacute;es comme DoS , SQL Injection , et des contaminations par variables.");
...
define($constpref."_CONTAMI_ACTIONDS","S&eacute;lectionner une action lorsque quelqu'un essaiera de contaminer des variables globales syst&egrave;me Xoosla!.<br />(Conseil : l'option &eacute;cran blanc est recommand&eacute;)");
...
define($constpref."_DISABLES","D&eacute;sactiver les fonctions dangereuses dans Xoosla!");
