...
define($constpref."_DESC","Modu³ zabezpieczaj±cy Xoosla!, przed ró¿nymi
...
pliki (tak/nie)');
define($constpref.'_DIE_BADEXTDSC','Je¶li kto¶ próbuje wgraæ pliki z niebezpiecznymi rozszerzeniami, jak .php ,Protector zamknie Xoosla!. Je¶li czêsto do³±czasz pliki php do B-Wiki albo PukiWikiMod, byæ mo¿e bêdziesz musia³ wy³±czyæ tê funkcjê.');
define($constpref.'_CONTAMI_ACTION','Dzia³anie w przypadku wykrycia
próby ska¿enia zmiennych');
define($constpref.'_CONTAMI_ACTIONDS','Wybierz dzia³anie, jakie ma byæ podjête, gdy kto¶ próbuje skaziæ globalne zmienne systemu w Twoim Xoosla!. Mo¿liwo¶ci:)');
