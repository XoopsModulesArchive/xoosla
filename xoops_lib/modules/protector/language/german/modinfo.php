...
define($constpref."_DESC","Dieses Modul schützt vor Angriffen aufür Ihre Xoosla!-Seite (DoS , SQL Injektion und Variablen Infektionen)");
...
define($constpref.'_DIE_BADEXTDSC','Wenn jemand versucht, Dateien mit unzulässigen Endungen wie .php hochzuladen, beendet diese Modul den Zugriff für Xoosla!.<br />Wenn Sie oft Dateien in B-Wiki oder PukiWikiMod einstellen, schalten Sie diese Option aus.');
define($constpref.'_CONTAMI_ACTION','Maßnahmen, wenn eine Verunreinigung gefunden wurde:');
define($constpref.'_CONTAMI_ACTIONDS','Wählen Sie eine Aktion aus, wenn jemand versucht, globale Xoosla!-Variablen zu verunreinigen.<br />(Empfohlen wird "Weißer Bildschirm")');
...
define($constpref.'_DISABLES','Deaktiviert die Sicherheitsfeatures von Protector in Xoosla!');
