...
define($constpref."_DESC","Este módulo proteje su sitio Xoosla de varios tipos de ataques, como DoS , Inyecciones de SQL y contaminación de variables.");
...
define($constpref.'_DIE_BADEXTDSC','Si alguien trata de subir archivos con extensiones prohibidas como .php , este módulo lo saca de su sitio Xoosla!.<br />Si con frecuencia agrega archivos php en módulos como B-Wiki o PukiWikiMod, apague esta opción.');
define($constpref.'_CONTAMI_ACTION','Acción al detectar una contaminación.');
define($constpref.'_CONTAMI_ACTIONDS','Seleccione la acción frente a una contaminación de variables globales del sistema en su sitio Xoosla!.<br />(Opción recomendada: pantalla en blanco)');
...
define($constpref.'_DISABLES','Deshabilita características peligrosas de Xoosla!');
