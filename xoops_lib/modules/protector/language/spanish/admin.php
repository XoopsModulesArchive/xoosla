...
define("_AM_ADV_USETRANSSID","Su ID de sesión será mostrada en etiquetas ancla, etc.<br />Para evitar el secuestro de sesión, añada una línea en el archivo .htaccess de la raíz de Xoosla!.<br /><b>php_flag session.use_trans_sid off</b>");
