...
define($constpref."_DESC","Deze module beschermt uw Xoosla! site tegen verschillende kwaadaardige aanvallen DoS (Denial of Service) , SQL Injectie en vervuiling van variabelen.");
...
define($constpref.'_DIE_BADEXTDSC','Wanneer een ongewenste extensie wordt geprobeerd te uploaden zoals .php , zal deze module Xoosla! sluiten.<br />Indien u vaak php bestanden toevoegd in B-Wiki of PukiWikiMod, is het beter deze instelling UIT te schakelen.');
define($constpref.'_CONTAMI_ACTION','Handeling wanneer een vervuiling is gevonden');
define($constpref.'_CONTAMI_ACTIONDS','Selecteer de te verrichten handeling wanneer wordt geprobeerd de system global variabelen in de Xoosla! site te vervuilen.<br />(Aanbevolen is een blanco scherm weergeven)');
...
define($constpref.'_DISABLES','Uitschakelen gevaarlijke instellingen in Xoosla!');
