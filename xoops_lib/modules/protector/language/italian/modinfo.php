...
define($constpref."_DESC","Questo modulo protegge il tuo sito Xoosla! da diversi tipi di attacchi, come i Denial Of Service, Iniezione SQL, e contaminazione delle variabili.");
...
define($constpref.'_DIE_BADEXTDSC','Se qualcuno cerca di effettuare l\'upload di file con estensione potenzialmente pericolosa (ad es. .php), il modulo esce da Xoosla!.<br />Se carichi spesso file php in moduli tipo B-Wiki o PukiWikiMod, disattivare questa funzione.');
define($constpref.'_CONTAMI_ACTION','Azione se rilevata contaminazione');
define($constpref.'_CONTAMI_ACTIONDS','Seleziona l\'azione da intraprendere qualora venga identificata una contaminazione delle variabili globali di sistema in Xoosla!.<br />(Raccomandato: schermata bianca)');
...
define($constpref.'_DISABLES','Disabilita funzionalit&agrave; pericolose di Xoosla!');
