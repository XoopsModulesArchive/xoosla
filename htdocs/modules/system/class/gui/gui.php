...
class XoopsGui extends /* implements */ XoopsSystemGui
{
    /**
    ...
    function header()
    {
        ...
        if (!@include_once XOOPS_ROOT_PATH . "/modules/system/language/" . $xoopsConfig["language"] . "/cpanel.php") {
        ...
        <?php
            ...
            <table border='0' cellpadding='0' cellspacing='0' width='100%'>
              <tr>
                ...
                <td width='15%' valign='top' class='bg5' align='left'><img src='".XOOPS_URL."/modules/system/images/menu.gif' /><br />
