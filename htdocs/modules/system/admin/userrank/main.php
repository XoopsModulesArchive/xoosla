    ...
    case "RankForumAdd":
        ...
        if ( !$db->query( $sql ) ) {
            ...
            if ( $uploader->getErrors() ) {
                redirect_header( "admin.php?fct=userrank&amp;op=RankForumAdmin", 3, xoops_error( $uploader->getErrors() ) . _MD_AM_DBUPDATED );
            } else {
                redirect_header( "admin.php?fct=userrank&amp;op=RankForumAdmin", 3, _MD_AM_DBUPDATED );
            }
        }
        break;
