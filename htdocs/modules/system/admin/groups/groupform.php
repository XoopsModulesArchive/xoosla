...
$r_lblock_checkbox = new XoopsFormCheckBox('<strong>'._LEFT.'</strong><br />', "read_bids[]", $r_block_value);
$r_lblock_checkbox->columns = 5;
$new_blocks_array = array();
$blocks_array = XoopsBlock::getAllBlocks("list", XOOPS_SIDEBLOCK_LEFT);
foreach ($blocks_array as $key => $value) {
    $new_blocks_array[$key] = "<a href='".XOOPS_URL."/modules/system/admin.php?fct=blocksadmin&amp;op=edit&amp;bid=".$key."' title='ID: {$key}'>".$value." (ID: {$key})</a>";
}
$r_lblock_checkbox->addOptionArray($new_blocks_array);

$r_cblock_checkbox = new XoopsFormCheckBox("<strong>"._CENTER."</strong><br />", "read_bids[]", $r_block_value);
$r_cblock_checkbox->columns = 5;
$new_blocks_array = array();
...
$r_rblock_checkbox = new XoopsFormCheckBox("<strong>"._RIGHT."</strong><br />", "read_bids[]", $r_block_value);
$r_rblock_checkbox->columns = 5;
$new_blocks_array = array();
