...
?>
<link rel="stylesheet" type="text/css" media="all" href="<?php echo XOOPS_URL;?>/include/javascript/calendar/calendar-blue.css" />
<script type="text/javascript" src="<?php echo XOOPS_URL.'/include/javascript/calendar/calendar.js';?>"></script>
