...
class XoopsFormColorPicker extends XoopsFormText
{
	...
	function render() {
		if (isset($GLOBALS['xoTheme'])) {
			$GLOBALS['xoTheme']->addScript('include/javascript/colorpicker/color-picker.js');
		} else {
			echo "<script type=\"text/javascript\" src=\"".XOOPS_URL."/include/javascript/colorpicker/color-picker.js\"></script>";
		}
