...
class FilterJavascript {
    ...
    {
        /**
         * This removes and Javascript links within the imput code
         */
        $array->search[] = htmlspecialchars( "#<a.+?href=.*?(alert\(|alert&\#40;|javascript\:|window\.|document\.|\.cookie|<script|<xss).*?\>.*?</a>#si" );
        $array->replace[] = '';
        return $array;
    }
}
