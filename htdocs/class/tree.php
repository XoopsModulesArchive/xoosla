...
class XoopsObjectTree {
	 ...
	 * @param   string  $extra           string to add extra javascript to select box
	 * @param   bool    $display         select to display or simply return contents of selectbox
*  	 * @return  string  HTML select box
	 **/
	function makeSelBox( $name, $fieldName, $prefix='-', $selected='', $addEmptyOption = false, $key=0, $extra = '', $display = false )
    {
