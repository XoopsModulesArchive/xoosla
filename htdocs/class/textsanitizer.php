 ...
 * @version $Id: textsanitizer.php 1536 2008-05-02 04:23:55Z phppp $
 */
...
class MyTextSanitizer {
    ...
    */
    ...
    {
        $filename = empty( $filename ) ? 'config.php' : 'config' . ( string )$filename . '.php';
    ...
    */
    ...
    function loadExtension( $name )
    {
        if ( ! @include_once "{$this->path_basic}/{$name}.php" ) {
            if ( ! include_once "{$this->path_plugin}/{$name}.php" ) {
                return false;
            }
        }
