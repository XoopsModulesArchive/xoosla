...
define( '_MD_AM_SLOGAN', 'The Slogan For Your Website:' );
...
define( '_MD_AM_CUSTOM_REDIRECT_DESC', 'Replace old redirection by jGrowl redirection<br />jGrowl is a jQuery plugin that raises unobtrusive messages within the Xoosla!' );
...
define( '_MD_AM_DEBUGMODE4', 'Enable Developer Mode' );
...
define( '_MD_AM_METAKEYDSC', 'The keywords meta tag is a series of keywords that represents the content of your site. Type in keywords with each separated by a comma or a space in between. (Ex. Xoosla!, PHP, mySQL, portal system)' );
...
define( '_MD_AM_SOAP_FILTERPERSONDESC', 'Special Accounts that use Xoosla! Authentication.' );
...
define( '_MD_AM_SOAP_FIELDMAPPING', 'Xoosla-Auth server fields mapping' );
define( '_MD_AM_SOAP_FIELDMAPPINGDESC', 'Describe here the mapping between the Xoosla database field and the LDAP Authentication system field.' .
	'<br><br>Format [Xoosla Database field]=[Auth system SOAP attribute]' .
	'<br>for example : email=mail' .
	'<br>Separate each with a |' .
	'<br><br>!! For advanced users !!' );
// Xoosla! Authentication constants
define( '_MD_AM_AUTH_CONFOPTION_XOOPS', 'Xoosla Database' );
...
define( '_MD_AM_AUTH_CONFOPTION_SOAP', 'Xoosla Soap Authentication' );
...
define( '_MD_AM_LDAP_USERS_BYPASS_DESC', 'Users to be authenticated with native Xoosla method.' );
...
define( '_MD_AM_LDAP_LOGINLDAP_ATTR_D', 'When Login name use in the DN option is set to yes, must correspond to the login name Xoosla' );
define( '_MD_AM_LDAP_LOGINNAME_ASDN', 'Login name use in the DN' );
define( '_MD_AM_LDAP_LOGINNAME_ASDN_D', 'The Xoosla login name is used in the LDAP DN (eg : uid=<loginname>,dc=xoops,dc=org)<br>The entry is directly read in the LDAP Server without search' );
...
define( '_MD_AM_LDAP_PROVIS', 'Automatic Xoosla Account Provisionning' );
define( '_MD_AM_LDAP_PROVIS_DESC', 'Create Xoosla user database if not exists' );
...
define( '_MD_AM_LDAP_FIELD_MAPPING_ATTR', 'Xoosla-Auth Server Fields Mapping' );
define( '_MD_AM_LDAP_FIELD_MAPPING_DESC', 'Describe here the mapping between the Xoosla database field and the LDAP Authentication system field.' .
	'<br /><br />Format [Xoosla Database field]=[Auth system LDAP attribute]' .
	'<br />for example : email=mail' .
	'<br />Separate each with a |' .

	'<br /><br />!! For advanced users. !!' );
define( '_MD_AM_LDAP_PROVIS_UPD', 'Maintain Xoosla Account Provisionning' );
define( '_MD_AM_LDAP_PROVIS_UPD_DESC', 'The Xoosla User account is always synchronized with the Authentication Server' );
