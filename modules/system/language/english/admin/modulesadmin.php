...
define( '_AM_SYSTEM_MODULES_TIPS', '<ul><li>If you install a new module, remember to setup module preferences, blocks and users permissions!</li><li>For hide module into Main Menu block, set order to 0</li><li>Delete unused module files from your server to avoid security issues and keep your website safe.</li><li>To change order of modules (which will be reflected in the Menu), you just need to drag and drop the modules to the desired placement.</li></ul>' );
define( '_AM_SYSTEM_MODULES_CONFIRM_TIPS', '<ul><li>Check all modifications for validate.</li></ul>' );
