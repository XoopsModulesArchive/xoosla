...
if ( !$GLOBALS['xoopsUser'] || $GLOBALS['xoopsConfigUser']['allow_chgmail'] != 1 ) {
	redirect_header( XOOPS_URL . '/modules/' . $GLOBALS['xoopsModule']->getVar( 'dirname', 'n' ) . '/', 1, _NOPERM );
}
...
//	include_once $GLOBALS['xoops']->path( 'class/xoopsformloader.php' );
	...
	redirect_header( XOOPS_URL . '/modules/' . $GLOBALS['xoopsModule']->getVar( 'dirname', 'n' ) . '/userinfo.php?uid=' . $GLOBALS['xoopsUser']->getVar( 'uid' ), 1, $msg );
}
