...
class ProfileProfileHandler extends XoopsPersistableObjectHandler {
	 ...
	 * @return bool
	 */
	public function insertField( ProfileProfile &$field, $force = false )
	{
	 ...
	 * @return bool
	 */
	public function deleteField( ProfileProfile &$field, $force = false )
	{
	 ...
	 * @return array
	 */
	public function search( CriteriaElement $criteria = null, $searchvars = array(), $groups = null )
	{
		$uservars = $this->getUserVars();
