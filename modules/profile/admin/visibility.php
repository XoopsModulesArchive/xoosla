...
if ( isset( $_REQUEST['submit'] ) ) {
	...
	redirect_header( 'visibility.php', 1, sprintf( _PROFILE_AM_SAVEDSUCCESS, _PROFILE_AM_PROF_VISIBLE ) );
	exit();
}
if ( $op == 'del' ) {
	...
	redirect_header( 'visibility.php', 1, sprintf( _PROFILE_AM_DELETEDSUCCESS, _PROFILE_AM_PROF_VISIBLE ) );
	exit();
}
