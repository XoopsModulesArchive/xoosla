...
// disable caching since the URL will be the same, but content different from one user to another
...
$pmform->addElement( new XoopsFormButton( '', 'move_messages', ( $_REQUEST['op'] == 'save' ) ? _PM_UNSAVE : _PM_TOSAVE, 'submit' ) );
$pmform->addElement( new XoopsFormButton( '', 'delete_messages', _PM_DELETE, 'submit' ) );
$pmform->addElement( new XoopsFormButton( '', 'empty_messages', _PM_EMPTY, 'submit' ) );
