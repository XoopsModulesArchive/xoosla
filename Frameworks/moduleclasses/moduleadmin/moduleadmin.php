...
class ModuleAdmin
{
    ...
    function renderAbout($paypal = '', $logo_xoops = true)
    {
        ...
        <label>' . _AM_MODULEADMIN_ABOUT_WEBSITE . '</label><text><a href="http://' . $this->_obj->getInfo("module_website_url") . '" rel="external" title="'. $this->_obj->getInfo("module_website_name") . ' - ' . $this->_obj->getInfo("module_website_url") . '">
