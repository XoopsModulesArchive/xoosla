...
if ( ! defined( "XOOPS_FOOTER_INCLUDED" ) ) {
	...
	if ( $xoopsOption['theme_use_smarty'] == 0 ) {
		// the old way
		$footer = htmlspecialchars( $xoopsConfigMetaFooter['footer'] ) . '<br /><div class="txtcenter small">Powered by Xoosla &copy; <a href="http://sourceforge.net/projects/xoosla/files/" rel="external" title="Xoosla">Xoosla</a></div>';
