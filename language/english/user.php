...
define( '_US_USERPROFILE', 'User Profile' );
...
define( '_US_ALLOWVIEWEMAIL', 'Display Email' );
define( '_US_ALLOWVIEWEMAIL_DSC', 'Allow other users to view my email address' );
define( '_US_WEBSITE', 'Website' );
define( '_US_TIMEZONE', 'Time Zone' );
define( '_US_TIMEZONE_DSC', '' );
...
define( '_US_SORRYNOTFOUND', 'Sorry, no selected user info was found.' );
...
define( '_US_REALNAME_DSC', '' );
define( '_US_SHOWSIG', 'Always attach my signature' );
define( '_US_SHOWSIG_DSC', '' );
define( '_US_CDISPLAYMODE', 'Comments Display Mode' );
define( '_US_CDISPLAYMODE_DSC', '' );
define( '_US_CSORTORDER', 'Comments Sort Order' );
define( '_US_CSORTORDER_DSC', '' );
define( '_US_PASSWORD', 'Password' );
define( '_US_TYPEPASSTWICE', 'Please enter twice to verify your password.' );
define( '_US_SAVECHANGES', 'Save Changes' );
define( '_US_NOEDITRIGHT', "Sorry, you don't have the right to edit this user's profile." );
...
define( '_US_NOTIFYMODE', 'Notification Mode' );
define( '_US_NOTIFYMODE_DSC', '' );
define( '_US_NOTIFYMETHOD', 'Notification Method' );
define( '_US_NOTIFYMETHOD_DSC', '' );
define( '_US_THEME', 'Theme' );
define( '_US_THEME_DSC', '' );

define( '_US_URL_TITLE', 'Website' );
define( '_US_URL_TITLE_DSC', '' );

define( '_US_SKYPE', 'Skype' );
define( '_US_SKYPE_DSC', '' );
define( '_US_FACEBOOK', 'Facebook' );
define( '_US_FACEBOOK_DSC', '' );
define( '_US_TWITTER', 'Twitter' );
define( '_US_TWITTER_DSC', '' );
