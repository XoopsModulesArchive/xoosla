...
function smarty_compiler_xoRssIcon( $parms, &$smarty )
{
	global $xoTheme;

	//$path = ( isset( $xoTheme ) && is_object( $xoTheme ) ) ? $xoTheme->resourcePath( '/img/logos/logo.png' ) : $parms;

	//$ret = '<img src="'.$GLOBALS['xoops']->url( $path ).'" alt="RSS" />';
