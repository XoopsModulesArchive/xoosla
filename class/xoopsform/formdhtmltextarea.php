...
class XoopsFormDhtmlTextArea extends XoopsFormTextArea {
	...
	public function render()
	{
        ...
        $ret .= "<img src='" . XOOPS_URL . "/images/icons/e_question.gif' alt='" . _XOOPS_FORM_ALT_LENGTH . "' title='" . _XOOPS_FORM_ALT_LENGTH . "' onclick=\"XoopsCheckLength('" . $this->getName() . "', '" . @$this->configs['maxlength'] . "', '" . _XOOPS_FORM_ALT_LENGTH . "', '" . _XOOPS_FORM_ALT_LENGTH_MAX . "');\" onmouseover='style.cursor=\"hand\"'/>";
		...
		if ( empty( $this->skipPreview ) ) {
			...
			. "   class='button' "
			. "   value='" . _PREVIEW . "' "
			. "   onclick=\"form_instantPreview('" . XOOPS_URL . "', '" . $this->getName() . "','" . XOOPS_URL . "/images', " . intval( $this->doHtml ) . ", '" . $GLOBALS['xoopsSecurity']->createToken() . "')\"" . " />";
			$ret .= ""
			    . "<div id='" . $this->getName() . "_hidden' style='display: block;'> "
			    . "   <fieldset>"
			    . "       <legend>" . $button . "</legend>"
			    . "       <div id='" . $this->getName() . "_hidden_data'>" . _XOOPS_FORM_PREVIEW_CONTENT . "</div>"
			    . "   </fieldset>"
			    . "</div>";
		}
		// Load javascript
		if ( empty( $js_loaded ) ) {
			$javascript = ( ( $this->js ) ? '<script language="JavaScript" type="text/javascript">' . $this->js . '</script>' : '' ) . '<script language="JavaScript" type="text/javascript" src="' . XOOPS_URL . '/include/js/formdhtmltextarea.js"></script>';
			$ret = $javascript . $ret;
			$js_loaded = true;
		}
		return $ret;
	...
	public function codeIcon()
	{
		...
		$code = "<a name='moresmiley'></a>" . "<img src='" . XOOPS_URL . "/images/icons/e_url.gif' alt='" . _XOOPS_FORM_ALT_URL . "' title='" . _XOOPS_FORM_ALT_URL . "' onclick='xoopsCodeUrl(\"{$textarea_id}\", \"" . htmlspecialchars( _ENTERURL, ENT_QUOTES ) . "\", \"" . htmlspecialchars( _ENTERWEBTITLE, ENT_QUOTES ) . "\");' onmouseover='style.cursor=\"hand\"'/>&nbsp;" . "<img src='" . XOOPS_URL . "/images/icons/e_email.gif' alt='" . _XOOPS_FORM_ALT_EMAIL . "' title='" . _XOOPS_FORM_ALT_EMAIL . "' onclick='xoopsCodeEmail(\"{$textarea_id}\", \"" . htmlspecialchars( _ENTEREMAIL, ENT_QUOTES ) . "\");'  onmouseover='style.cursor=\"hand\"'/>&nbsp;" . "<img src='" . XOOPS_URL . "/images/icons/e_imgsrc.gif' alt='" . _XOOPS_FORM_ALT_IMG . "' title='" . _XOOPS_FORM_ALT_IMG . "' onclick='xoopsCodeImg(\"{$textarea_id}\", \"" . htmlspecialchars( _ENTERIMGURL, ENT_QUOTES ) . "\", \"" . htmlspecialchars( _ENTERIMGPOS, ENT_QUOTES ) . "\", \"" . htmlspecialchars( _IMGPOSRORL, ENT_QUOTES ) . "\", \"" . htmlspecialchars( _ERRORIMGPOS, ENT_QUOTES ) . "\", \"" . htmlspecialchars( _XOOPS_FORM_ALT_ENTERWIDTH, ENT_QUOTES ) . "\");'  onmouseover='style.cursor=\"hand\"'/>&nbsp;" . "<img src='" . XOOPS_URL . "/images/icons/e_image.gif' alt='" . _XOOPS_FORM_ALT_IMAGE . "' title='" . _XOOPS_FORM_ALT_IMAGE . "' onclick='openWithSelfMain(\"" . XOOPS_URL . "/imagemanager.php?target={$textarea_id}\",\"imgmanager\",400,430);'  onmouseover='style.cursor=\"hand\"'/>&nbsp;" . "<img src='" . XOOPS_URL . "/images/icons/e_smiley.gif' alt='" . _XOOPS_FORM_ALT_SMILEY . "' title='" . _XOOPS_FORM_ALT_SMILEY . "' onclick='openWithSelfMain(\"" . XOOPS_URL . "/misc.php?action=showpopups&amp;type=smilies&amp;target={$textarea_id}\",\"smilies\",300,475);'  onmouseover='style.cursor=\"hand\"'/>&nbsp;";
		...
		$code .= "<img src='" . XOOPS_URL . "/images/icons/e_code.gif' alt='" . _XOOPS_FORM_ALT_CODE . "' title='" . _XOOPS_FORM_ALT_CODE . "' onclick='xoopsCodeCode(\"{$textarea_id}\", \"" . htmlspecialchars( _ENTERCODE, ENT_QUOTES ) . "\");'  onmouseover='style.cursor=\"hand\"'/>&nbsp;" .
		    "<img src='" . XOOPS_URL . "/images/icons/e_quote.gif' alt='" . _XOOPS_FORM_ALT_QUOTE . "' title='" . _XOOPS_FORM_ALT_QUOTE . "' onclick='xoopsCodeQuote(\"{$textarea_id}\", \"" . htmlspecialchars( _ENTERQUOTE, ENT_QUOTES ) . "\");' onmouseover='style.cursor=\"hand\"'/>";
	...
	public function fontArray()
	{
		...
		$fontStr = "<script type=\"text/javascript\" language=\"JavaScript\">"
		 . "var _editor_dialog = ''"
		 . "+ '<select id=\'{$textarea_id}Size\' onchange=\'xoopsSetElementAttribute(\"size\", this.options[this.selectedIndex].value, \"{$textarea_id}\", \"{$hiddentext}\");\'>'"
		...
		$styleStr = "<img src='" . XOOPS_URL . "/images/icons/e_bold.gif' alt='" . _XOOPS_FORM_ALT_BOLD . "' title='" . _XOOPS_FORM_ALT_BOLD . "' onmouseover='style.cursor=\"hand\"' onclick='xoopsMakeBold(\"{$hiddentext}\", \"{$textarea_id}\");' />&nbsp;";
		$styleStr .= "<img src='" . XOOPS_URL . "/images/icons/e_italic.gif' alt='" . _XOOPS_FORM_ALT_ITALIC . "' title='" . _XOOPS_FORM_ALT_ITALIC . "' onmouseover='style.cursor=\"hand\"' onclick='xoopsMakeItalic(\"{$hiddentext}\", \"{$textarea_id}\");' />&nbsp;";
		$styleStr .= "<img src='" . XOOPS_URL . "/images/icons/e_underline.gif' alt='" . _XOOPS_FORM_ALT_UNDERLINE . "' title='" . _XOOPS_FORM_ALT_UNDERLINE . "' onmouseover='style.cursor=\"hand\"' onclick='xoopsMakeUnderline(\"{$hiddentext}\", \"{$textarea_id}\");'/>&nbsp;";
		$styleStr .= "<img src='" . XOOPS_URL . "/images/icons/e_linethrough.gif' alt='" . _XOOPS_FORM_ALT_LINETHROUGH . "' title='" . _XOOPS_FORM_ALT_LINETHROUGH . "' onmouseover='style.cursor=\"hand\"' onclick='xoopsMakeLineThrough(\"{$hiddentext}\", \"{$textarea_id}\");' /></a>&nbsp;";

		$alignStr = "<img src='" . XOOPS_URL . "/images/icons/e_alignleft.gif' alt='" . _XOOPS_FORM_ALT_LEFT . "' title='" . _XOOPS_FORM_ALT_LEFT . "' onmouseover='style.cursor=\"hand\"' onclick='xoopsMakeLeft(\"{$hiddentext}\", \"{$textarea_id}\");' />&nbsp;";
		$alignStr .= "<img src='" . XOOPS_URL . "/images/icons/e_aligncenter.gif' alt='" . _XOOPS_FORM_ALT_CENTER . "' title='" . _XOOPS_FORM_ALT_CENTER . "' onmouseover='style.cursor=\"hand\"' onclick='xoopsMakeCenter(\"{$hiddentext}\", \"{$textarea_id}\");' />&nbsp;";
		$alignStr .= "<img src='" . XOOPS_URL . "/images/icons/e_alignright.gif' alt='" . _XOOPS_FORM_ALT_RIGHT . "' title='" . _XOOPS_FORM_ALT_RIGHT . "' onmouseover='style.cursor=\"hand\"' onclick='xoopsMakeRight(\"{$hiddentext}\", \"{$textarea_id}\");' />&nbsp;";
		$fontStr = $fontStr . "<br />\n{$styleStr}&nbsp;{$alignStr}\n";
		return $fontStr;
	}
