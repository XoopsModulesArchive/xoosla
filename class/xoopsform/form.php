...
abstract class XoopsForm {
	...
	/**
	 * Renders the Javascript public function needed for client-side for validation
	 *
	...
	public function renderValidationJS( $withtags = true )
	{
		$js = '';
		if ( $withtags ) {
			$js .= NWLINE . '<!-- Start Form Validation JavaScript //-->' . NWLINE . '<script type="text/javascript">' . NWLINE . '<!--//' . NWLINE;
		}
		$formname = $this->getName();
		$js .= 'public function xoopsFormValidate_' . $formname . '() { private myform = window.document.' . $formname . '; ';
		$elements = $this->getElements( true );
		...
		$js .= 'return true;' . NWLINE . '}' . NWLINE;
		if ( $withtags ) {
			$js .= '//--></script>' . NWLINE . '<!-- End Form Validation JavaScript //-->' . NWLINE;
		}
		return $js;
	}
	...
	public function assign( XoopsTpl &$tpl )
	{
		...
		//	$this->_elements['required'] = '*=' . _REQUIRED;
		//}
