...
class MytsMycode extends MyTextSanitizerExtension
{
    ...
    function encode($textarea_id)
    {
        ...
        // Make sure that the icon is available /images/form/myicons/code.gif
        $code = "<img src='{$this->image_path}/myicons/code.gif' alt='" . _XOOPS_FORM_ALTMYCODE . "' onclick='xoopsCodeMycode(\"{$textarea_id}\",\"" . htmlspecialchars(_XOOPS_FORM_ENTERMYCODETERM, ENT_QUOTES) . "\");'  onmouseover='style.cursor=\"hand\"'/>&nbsp;";
        $javascript = <<<EOH
