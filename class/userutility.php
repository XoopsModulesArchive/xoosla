...
class XoopsUserUtility {
	 ...
	 */
	public function getIP( $asString = false )
	{
	 ...
	 * @return
	 */
	public function getUnameFromIds( $uid, $usereal = false, $linked = false )
	{
		if ( !is_array( $uid ) ) {
			$uid = array( $uid );
		}
	 ...
	 * @return
	 */
	public function getUnameFromId( $userid, $usereal = false, $linked = false )
	{
		$myts = MyTextSanitizer::getInstance();
