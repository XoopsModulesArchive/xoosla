...
class db_manager {
	...
	var $successStrings = array(
		'create' => INSTALL_TABLE_CREATED,
		'insert' => INSTALL_ROWS_INSERTED,
		'alter' => INSTALL_TABLE_ALTERED,
		'drop' => INSTALL_TABLE_DROPPED,
		);
	var $failureStrings = array(
		'create' => INSTALL_TABLE_NOT_CREATED,
		'insert' => INSTALL_ROWS_FAILED,
		'alter' => INSTALL_TABLE_NOT_ALTERED,
		'drop' => INSTALL_TABLE_NOT_DROPPED,
		);
	...
	{
		$this->db->connect();
		return $this->db->fetchRow( $ret );
	}

	/**
	 * db_manager::getRowsNum()
	 *
	 * @param mixed $result
	 * @return
	 */
