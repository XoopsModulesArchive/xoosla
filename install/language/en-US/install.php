...
define( 'INSTALL_CONFIG_CHECK_MSG', 'A administrator account is required to allow you to sign into your new webportal. For security reasons, we suggest that you keep this information in a safe place and create a new account for new administrators.' );
