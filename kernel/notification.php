...
class XoopsNotificationHandler extends XoopsObjectHandler {
	 ...
	 * @return bool
	 */
	function insert( XoopsNotification &$notification )
	{
	 ...
	 * @return bool
	 */
	function delete( XoopsNotification &$notification )
	{
	 ...
	 * @return int Count
	 */
	function getCount( CriteriaElement $criteria = null )
	{
	 ...
	 * @return bool
	 */
	function deleteAll( CriteriaElement $criteria = null )
	{
